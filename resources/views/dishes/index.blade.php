                                        ...
                                        <tr>
                                            <td>
                                                @if ($dish->image)
                                                    <img src="{{ asset('storage/' . $dish->image) }}"
                                                        class="img-thumbnail-small" alt="Immagine del piatto">
                                                @else
                                                    <img src="{{ asset('https://img.freepik.com/foto-premium/un-segnale-non-mi-e-piaciuto-il-piatto-piatto-blu-vuoto-e-pulito-con-forchetta-e-coltello-su-un-tavolo-di-legno-come-esempio-di-galateo-a-tavola_898094-72.jpg') }}"
                                                        class="img-thumbnail-small" alt="Immagine di cortesia">
                                                @endif
                                            </td>
                                            <td>
                                                {{ $dish->name }}
                                            ...
                                            <td>
                                                <div class="btn-group" role="group" aria-label="Azioni">
                                                    ...
                                                    <button type="button" class="btn btn-outline-danger sm rounded"
