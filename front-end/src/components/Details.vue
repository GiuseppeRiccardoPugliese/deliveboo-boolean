        ...
        <div class="row mx-3 mb-3" v-if="ristoranti[this.$route.params.index]">
            ...
            <div class="col-12 col-md-6 text-center text-md-start mb-4">
                ...
                <div class="my-4 d-flex justify-content-center justify-content-md-start">
                    <div v-for="(type, index) in ristoranti[this.$route.params.index].tipologies" :key="index" class="bg_brown type_border d-flex align-items-center justify-content-center my-1 mx-1" style="width: fit-content;">
